...
1. Добавить в папку test 3 три файла 4, 5 и 6, в каждом из которых должно быть по 4 строки row1, row2, row3, row4
...
2. Найдите строку row2 в файле 5
...
1. Посчитайте сколько строк с содержимым row в файле 6

grep row test3/6.txt | wc -l

1. Найдите файл 5 внутри папки test3

find test3 -name "5.txt”

1. Используя команду find, удалите файл 5

(find test3 -name "5.txt" -exec rm {} \; ) (find test3 -name "5.txt" | xargs rm)

1. Используя команду echo, добавьте слово test в файл 4

echo "test"> test3/4.txt

1. Замените слово test в файле 4 на fail

nano test3/4.txt

1. Добавьте в файл 4 слово test так, чтобы сохранилось содержимое

echo "test">> test3/4.txt

1. Просмотрите все процессы для юзеров не только в консоли, которые происходят в системе

ps aux

1. Убейте процесс 666 в консоли
kill 666
2. Узнайте доступность ресурса artsiomrusau.com, используя ping

ping artsiomrusau.com

1. Отправьте 5 пакетов на сайт artsiomrusau.com

ping -c 5 artsiomrusau.com

1. Используя GET и команду curl, получите информацию о зарегистрированных питомцах на https://petstore.swagger.io/
